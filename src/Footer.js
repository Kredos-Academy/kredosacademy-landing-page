...
function Footer() {
  return (
    <div >
        <div className='footer w-full lg:h-600 h-64 lg:pb-0 pb-96'>
            <h1 className='footer-text lg:text-7xl text-3xl text-center lg:font-semibold font-bold lg:ml-64 ml-10 lg:mr-64 mr-9 lg:pt-32 pt-20 '>Start learning with kredos academy</h1>
