  ...
  return (
    <div >
        <div className='footer w-full lg:h-600 h-64 lg:pb-0 pb-80'>
            <h1 className='footer-text lg:text-6xl text-3xl text-center lg:font-semibold font-extrabold lg:ml-60 ml-10 lg:mr-64 mr-9 lg:pt-32 pt-20 '>Start learning with kredos academy</h1>
            ...
            <div className="footer-button text-xs text-center font-semibold lg:w-40 w-28 lg:rounded-full rounded-3xl lg:h-16 h-10 lg:mt-6 mt-12 lg:ml-630 ml-32 no-underline">
